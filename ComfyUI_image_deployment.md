...
- run-comfyui-image is tested on RunPod using an **RTX A4500/A5000/A6000, RTX 3090** GPU.

### 🚀 RunPod Templates

- Flux.2 Klein downloads by default the 4B (none gated) model, see [tutorial](ComfyUI_image_hf_gated.md) to add the 9B gated model.  
