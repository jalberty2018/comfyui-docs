...
2. Set a suitable minimum amount of **system RAM** in the filters or use the default settings.
...
- For video generation, allocate at least two or three times as much system RAM as GPU VRAM.

For example, 60 GB of system RAM is a reasonable selection for image generation with an RTX 4090 with 24 GB of VRAM, for video generation more then 90 Gb is prefered.
...
### Assign volume disk (legacy)

- Choose volume disk for the fastest access.
- Preferably use or increase the volume assigned by the template.
- Encrypt volume if desired.

<details>
<summary><strong>View the Volume selection screen</strong></summary>

<img loading="lazy" src="../images/runpod_deploy_volume.jpg" alt="RunPod screen for volume selection" style="width: 100%; height: auto;">
...
- Try another region.
- Set the CUDA filter to **CUDA 13.0** in the RunPod console.

<details>
<summary><strong>View the CUDA filter</strong></summary>

<img loading="lazy" src="../images/filter_cuda.jpg" alt="RunPod filter selection" style="width: 100%; height: auto;">
<img loading="lazy" src="../images/filter_cuda2.jpg" alt="RunPod filter set to CUDA 13.0" style="width: 100%; height: auto;">
