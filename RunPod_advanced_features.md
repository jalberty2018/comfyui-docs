...
- Put your **public key** on RunPod.io and keep your **private key** on your local computer.
...
- File transfer [Shellfish](https://secureshellfish.app), [WinSCP](https://winscp.net/) or [Tabby terminal](https://tabby.sh/).
