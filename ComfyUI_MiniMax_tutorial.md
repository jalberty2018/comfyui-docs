...
[Start a pod on RunPod](ComfyUI_MiniMax_deployment.md)
...
![Select MiniMax workflow](images/ai-generated-MiniMax.jpg){ width="500" }
...
![send_lora](images/lora_manager_MiniMax.jpg){ width="450" }
...
Download the MiniMax H3 ConvRot text encoder from [Hugging Face](https://huggingface.co/Comfy-Org/MiniMax-H3/tree/main).
